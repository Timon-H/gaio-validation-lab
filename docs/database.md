...
- Curated `datasets/DATA_*.csv` files can be generated by exporting rows from `llm_evaluation_results`, `llm_evaluation_results_exploratory`, `llm_eval_comparison`, `llm_eval_comparison_exploratory`, `v_macro_f1_scores`, and `v_macro_f1_scores_exploratory`.
