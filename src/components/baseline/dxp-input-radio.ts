...
export class DxpInputRadio extends DxpFormBase {
  ...
  render() {
    ...
    return html`
      ${this.label
        ? html`<div class="radio-group-label" id=${this._groupLabelId}>
            ${this.label}
          </div>`
        : nothing}
      <div
        ...
        aria-labelledby=${ifDefined(
          this.label ? this._groupLabelId : undefined,
        )}
        aria-label=${ifDefined(
          !this.label && this.name ? this.name : undefined,
        )}
      >
      ...
      ${this._invalid
        ? html`<div class="error-message">${this.requiredErrorText}</div>`
        : nothing}
    `;
  }
}
