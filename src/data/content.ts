    ...
    tariffData: [
      {
        ...
        moduleConfigs: [
          {
            moduleReference: "deckung",
            moduleReferenceUuid: "1",
            value: { selectedText: "5 Mio. €" },
          },
          {
            moduleReference: "selbstbeteiligung",
            moduleReferenceUuid: "2",
            value: { selectedText: "150 €" },
          },
        ],
      },
      {
...
export const SECTION_HEADINGS = {
  buttons: {
    heading: "Aktionen",
    description:
      "Starten Sie Ihre Versicherungsberechnung oder erfahren Sie mehr über unsere Produkte.",
  },
  textInputs: {
    heading: "Persönliche Angaben",
    description:
      "Geben Sie Ihre Kontaktdaten ein, um ein individuelles Angebot zu erhalten.",
  },
  dropdown: {
    heading: "Versicherungstyp auswählen",
    description:
      "Wählen Sie die gewünschte Versicherungsart aus unseren Angeboten.",
  },
  radio: {
    heading: "Zahlungsweise",
    description:
      "Wählen Sie Ihre bevorzugte Zahlungsfrequenz für Ihren Versicherungsbeitrag.",
  },
  accordion: {
    heading: "Häufig gestellte Fragen",
    description:
      "Antworten auf die wichtigsten Fragen rund um unsere Versicherungsprodukte.",
  },
  cards: {
    heading: "Unsere Versicherungsprodukte",
  ...
  tariff: {
    ...
    description:
      "Wählen Sie den passenden Schutz für Ihre Bedürfnisse. Alle Preise verstehen sich als monatliche Beiträge.",
  },
} as const;
...
export const ARIA_LABELS = {
  ...
  tariff:
    "Tarifvergleich: Basis ab 3,50 €, Komfort ab 5,90 €, Premium ab 9,80 € monatlich",
} as const;
    ...
    offers: [
      {
        ...
        priceCurrency: "EUR",
        description:
          "Grundschutz – Deckungssumme 5 Mio. €, Selbstbeteiligung 150 €",
        itemOffered: {
          "@type": "Product",
      ...
      },
      {
        ...
        priceCurrency: "EUR",
        description:
          "Erweiterter Schutz – Deckungssumme 10 Mio. €, keine Selbstbeteiligung",
        itemOffered: {
          "@type": "Product",
      ...
      },
      {
        ...
        priceCurrency: "EUR",
        description:
          "Rundum-Sorglos – Deckungssumme 50 Mio. €, keine Selbstbeteiligung",
        itemOffered: {
          "@type": "Product",
