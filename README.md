...
supabase/
  ...
  migrations/            ← Incremental SQL migrations for non-destructive schema updates
...
| [docs/database.md](docs/database.md)                             | Supabase schema setup, writer payload contracts, migrations, and view query examples |
